...
class Material:
    ...
    def __init__(self, material):
        ...
        if self.name == Materials.SILICON:  # Ref. APL 95 161901 (2009)
        ...
        elif self.name == Materials.SILICON_CARBIDE:  # Ref. https://journals.aps.org/prb/pdf/10.1103/PhysRevB.50.17054
        ...
        elif self.name == Materials.DIAMOND:  # Ref. https://www.sciencedirect.com/science/article/pii/S0008622315003358
        ...
        elif self.name == Materials.ALUMINIUM_NITRIDE:  # Ref. Davydov, PRB 58, 12899 (1998)
