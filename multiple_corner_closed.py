...
# General parameters:
OUTPUT_FOLDER_NAME             ='multiple curve detected 5K_1'# 'multiple curve detected 10K' ,'test'
NUMBER_OF_PHONONS              = 15000
...
FREQUENCY_DETECTOR_2_SIZE        = 200e-9
FREQUENCY_DETECTOR_2_CENTER       = 80e-9
FREQUENCY_DETECTOR_3_SIZE        = 300e-9
...
HOLE_COORDINATES = np.zeros((NUMBER_OF_PERIODS_X * NUMBER_OF_PERIODS_Y+1, 3))
SCALING_FACTOR_RADIUS = np.zeros((NUMBER_OF_PERIODS_X * NUMBER_OF_PERIODS_Y+1, 1))
SCALING_FACTOR_INNER_RADIUS = np.zeros((NUMBER_OF_PERIODS_X * NUMBER_OF_PERIODS_Y+1, 1))
...
HOLE_COORDINATES[hole_number, 0] = 0#FIRST_HOLE_COORDINATE_X -(NUMBER_OF_PERIODS_X - 1) * PERIOD_X / 2 + j * PERIOD_X #-200*10**(-9)
