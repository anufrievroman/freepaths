# -*- coding: utf-8 -*-
"""
Created on Thu Jun 22 15:08:13 2023
...
# General parameters:
OUTPUT_FOLDER_NAME             ='test_2'# 'multiple curve detected 10K' ,'test'
...
HOLE_COORDINATES[hole_number, 0] = -PERIOD_X#FIRST_HOLE_COORDINATE_X -(NUMBER_OF_PERIODS_X - 1) * PERIOD_X / 2 + j * PERIOD_X #-200*10**(-9)
HOLE_COORDINATES[hole_number, 1] = 0  #+j//3*L_PERIOD_Y #FIRST_HOLE_COORDINATE + i * PERIOD_Y #1*10**(-6)
HOLE_COORDINATES[hole_number, 2] = 0        
SCALING_FACTOR_INNER_RADIUS[hole_number]= ar/2
SCALING_FACTOR_RADIUS[hole_number]=1.5
